                    ...
                    <?php foreach ($helps as $help): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php echo $parentsOptions[$help['Help']['parent_id']] ?>
                            </td>
                            ...
                            <td class="text-center" nowrap="nowrap">
                                <?php echo $this->Html->link(__('Edit'), array('action' => 'insert', $help['Help']['id'],'?'=>array('redirect_url'=>urlencode(Router::reverse($this->request, true)))),array('class'=>'btn btn-primary btn-xs','escape'=>false)); ?>
                                <?php if(!$help['Help']['status']):?>
