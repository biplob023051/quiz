...
<div class="row">
    <div class="col-md-12 text-right">
        <small><?php echo $this->Paginator->counter('Mostrando {:start} a {:current} de {:count} entradas');?></small>
    </div>
</div>
<!-- Quiz list -->
        ...
        <tbody id="quiz-list">
            ...
            <?php foreach ($quizzes as $id => $quiz): ?> 
                <tr>
                    ...
                    <td class="text-center valign-center"><?php echo h($quiz['User']['name']); ?></td>
